...
export default function Slider() {
  ...
  React.useEffect(() => {
    ...
    >
      {props.left && (
        <path d="M30 0 L4 30 L30 60" stroke="#00001f" strokeWidth="5" fill="none" />
      )}
      {!props.left && (
        <path d="M4 0 L30 30 L4 60" stroke="#00001f" strokeWidth="5" fill="none" />
      )}
    </svg>
      )}
  ...
  return (
    <>
           ...
           <div className="keen-slider__slide  flex flex-row !gap-2 justify-between h-[450px]">
          ...
          <img src="/hero_carousel_img_1.png" alt="Fiserv" className="w-55 object-contain rounded-3xl" />
        {/* <img>h</img> */}
        </div>
            <div className="keen-slider__slide flex flex-row !gap-2 justify-between h-[450px]">
            <div className="text-left md:text-left flex flex-col gap-4">
              <div>
            <span className="text-md font-medium text-[#1a1288]">Comprehensive</span>
            ...
            <img src="/hero_carousel_img_2.png" alt="Fiserv" className="w-55 object-contain rounded-3xl" />
          </div>
          ...
          <div className="text-left md:text-left flex flex-col gap-4">
            <div>
            <span  className="text-md font-medium text-[#1a1288]">Secure</span>
            ...
            <img src="hero_carousel_img_3.png" alt="Fiserv" className="w-55 object-contain rounded-3xl" />
          </div>
